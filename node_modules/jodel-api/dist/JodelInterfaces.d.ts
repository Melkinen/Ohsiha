...
export declare type Owner = "own" | "friend" | "friendsfriend" | "team";
export declare type UserTypeName = "highschooler" | "student";
export declare type AccessToken = string;
export declare const enum ModerationDecision {
    ACCEPT = 0,
    DISCARD = 2,
    SKIP = 1,
}
...
export declare type PostOwner = "friend" | "own" | "team";
export declare type VotedStatus = "up" | "down" | "";
...
export declare type StickyPostType = "info" | "link" | "survey";
...
export declare const enum FlagReasonEnum {
    DISCLOSURE = 1,
    HARRASSMENT = 2,
    OTHER = 4,
    REPOST = 6,
...
export declare type ExperimentalFeature = "flag_reason_change" | "post_pinning" | "school_screen" | "school_screen_block" | "tag_channels";
...
export declare type DeviceUID = string;
export declare type ClientID = string;
export declare type PostId = string;
export declare type Color = "FF9908" | "FFBA00" | "DD5F5F" | "06A3CB" | "8ABDB0" | "9EC41C";
...
export declare type HttpVerb = "post" | "get" | "put" | "delete" | "options" | "head" | "patch" | "connect" | "trace";
export declare type ApiVersion = "0.1" | "0.2";
